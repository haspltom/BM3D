...
DIRS    = objdir rgbdir yuvdir yuvgrpdir grpdir orgdir trmdir trydir trudir trvdir estdir esydir esudir esvdir resdir bmsdir dnsdir dnsydir dnsudir dnsvdir dnsgrpydir dnsgrpudir dnsgrpvdir
